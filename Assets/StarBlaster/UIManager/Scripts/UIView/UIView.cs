...
namespace DenkKits.UIManager.Scripts.UIView
{
    ...
    public class UIView : UIBaseComponent
    {
        ...
        public void Show(object p = null, bool isBack = false)
        {
            ...
            Base.UIManager.DebugLog("Show " + name, this);
            ...
            {
                Base.UIManager.DebugLog("Popup is showing, pls wait " + name, this);
                return;
            }
            ...
            {
                Base.UIManager.DebugLog("View was shown " + name, this);
        ...
        public void Hide(bool instantHide = false, bool isBack = false)
        {
            ...
            Base.UIManager.DebugLog("Hide View " + name, this);
            ...
            {
                Base.UIManager.DebugLog("View is hidding, pls wait " + name, this);
                return;
            }
...
//            Container.transform.DOKill(true);
        ...
        {
             Base.UIManager.DebugLog("OnBackClick " + name, this);
