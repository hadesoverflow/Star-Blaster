...
namespace DenkKits.UIManager.Scripts.UIButton
{
    ...
    public class UIButtonBehavior
    {
        ...
        public UIAnimation.UIAnimation PunchAnimation;
        
        /// <summary> State animation settings </summary>
        public UIAnimation.UIAnimation StateAnimation;
        ...
        public void Reset(UIButtonBehaviorType behaviorType)
        {
            ...
            PunchAnimation = new UIAnimation.UIAnimation(AnimationType.Punch);
            StateAnimation = new UIAnimation.UIAnimation(AnimationType.State);
            ...
            UnityAction onCompleteCallback = null)
        {
            ...
            switch (ButtonAnimationType)
            {
                ...
                case ButtonAnimationType.State:
                    ...
                    Base.UIManager.DebugLog("PlayAnimation " + button.name, this);
        ...
        private static IEnumerator InvokeCallbacks(UIAnimation.UIAnimation animation, UnityAction onStartCallback, UnityAction onCompleteCallback)
        {
