...
namespace DenkKits.UIManager.Scripts.UIAnimation
{
    ...
    public class UIAnimationComponent : UIBaseComponent
    {
        ...
        public void Show()
        {
            ...
            {
                Base.UIManager.DebugLog("Component is showing, pls wait " + name, this);
                return;
            }
            ...
            {
                Base.UIManager.DebugLog("Component was shown " + name, this);
            ...
            Base.UIManager.DebugLog("Show Anim " + name, this);
