...
namespace DenkKits.UIManager.Scripts.UIPopup
{
	...
	public class UIPopupManager : MonoBehaviour
	{
        ...
        public UIPopup GetPopup(UIPopupName name)
        {
            ...
            {
                Base.UIManager.DebugLog("No Popup with name " + name, this);
            }
            return popup;
        }
        ...
        {
            Base.UIManager.DebugLog("ShowPopup " + name, this);
        ...
        public UIPopup GetPopupFromCacheOrCreate(UIPopupName name)
        {
            ...
            if (popup)
            {
                Base.UIManager.DebugLog("Load dialog from cache " + name, this);
                return popup;
            }

            Base.UIManager.DebugLog("Create new dialog " + name, this);
