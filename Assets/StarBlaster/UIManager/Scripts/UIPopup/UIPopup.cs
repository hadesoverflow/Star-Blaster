...
namespace DenkKits.UIManager.Scripts.UIPopup
{
    ...
    public abstract class UIPopup : UIBaseComponent
    {
        ...
        {
            if (Container.RectTransform == null)
                Container.RectTransform = transform.Find("Container").AsRectTransform();
        ...
        public void Show(object p = null)
        {
            ...
            {
                Debug.LogError("You are trying to SHOW the (" + name +
                               ") UIPopup, but you did not enable any SHOW animations. Enable at least one SHOW animation in order to fix this issue.");
            ...
            if (Controller.AlwaysOnTop)
                ...
                OrderInParent =
                    Controller.PopupManager.GetLowestAlwaysOnTopPopupOrder() - 1; //dat sau popup always on top
            else
        ...
        private IEnumerator ShowEnumerator(bool instantAction)
        {
            ...
            UIAnimator.StopAnimations(Container.RectTransform,
                Controller.ShowBehavior.Animation.AnimationType); //stop any SHOW animations
            ...
            //PLAY SHOW ANIMATION
            //MOVE
            Vector3 moveFrom = UIAnimator.GetAnimationMoveFrom(Container.RectTransform,
                Controller.ShowBehavior.Animation, Vector3.zero);
            Vector3 moveTo = UIAnimator.GetAnimationMoveTo(Container.RectTransform, Controller.ShowBehavior.Animation,
                Vector3.zero);
            if (!Controller.ShowBehavior.Animation.Move.Enabled || instantAction)
                Container.ResetPosition();
            UIAnimator.Move(Container.RectTransform, Controller.ShowBehavior.Animation, moveFrom, moveTo,
            ...
            UIAnimator.Rotate(Container.RectTransform, Controller.ShowBehavior.Animation, rotateFrom, rotateTo,
            ...
            UIAnimator.Scale(Container.RectTransform, Controller.ShowBehavior.Animation, scaleFrom, scaleTo,
            ...
            UIAnimator.Fade(Container.RectTransform, Controller.ShowBehavior.Animation, fadeFrom, fadeTo,
        ...
        public virtual void Hide(bool instantHide = false)
        {
            ...
            {
                Debug.LogError("You are trying to HIDE the (" + name +
                               ") UIPopup, but you did not enable any HIDE animations. Enable at least one HIDE animation in order to fix this issue.");
        ...
        {
            UIAnimator.StopAnimations(Container.RectTransform,
                Controller.HideBehavior.Animation.AnimationType); //stop any HIDE animations

            //MOVE
            Vector3 moveFrom = UIAnimator.GetAnimationMoveFrom(Container.RectTransform,
                Controller.HideBehavior.Animation, Vector3.zero);
            Vector3 moveTo = UIAnimator.GetAnimationMoveTo(Container.RectTransform, Controller.HideBehavior.Animation,
                Vector3.zero);
            if (!Controller.HideBehavior.Animation.Move.Enabled || instantAction)
                Container.ResetPosition();
            UIAnimator.Move(Container.RectTransform, Controller.HideBehavior.Animation, moveFrom, moveTo,
            ...
            if (!Controller.HideBehavior.Animation.Rotate.Enabled || instantAction)
                Container.ResetRotation();
            UIAnimator.Rotate(Container.RectTransform, Controller.HideBehavior.Animation, rotateFrom, rotateTo,
            ...
            UIAnimator.Scale(Container.RectTransform, Controller.HideBehavior.Animation, scaleFrom, scaleTo,
            ...
            UIAnimator.Fade(Container.RectTransform, Controller.HideBehavior.Animation, fadeFrom, fadeTo,
            ...
            {
                yield return
                    new WaitForSecondsRealtime(Controller.HideBehavior.Animation.TotalDuration +
                                               0.05f); //wait for seconds realtime (ignore Unity's Time.Timescale)
            }
        ...
        {
            Base.UIManager.DebugLog("OnInit", this);
        }


        protected virtual void OnShown()
        {
            Base.UIManager.DebugLog("OnShown", this);
        }


        protected virtual void OnHiding()
        {
            Base.UIManager.DebugLog("OnHiding", this);
        }

        protected virtual void OnShowing()
        {
            Base.UIManager.DebugLog("OnShowing", this);
        }

        protected virtual void OnHidden()
        {
            Base.UIManager.DebugLog("OnHidden", this);
        }
