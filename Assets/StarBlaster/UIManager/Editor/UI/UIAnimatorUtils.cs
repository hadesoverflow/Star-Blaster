...
namespace Imba.Editor.UI
{
    public static class UIAnimatorUtils
    {
        ...
        public static void StopAllAnimations(RectTransform target)
        {
         ...
         public static void PreviewAnimation(UIBaseComponent view, UIAnimation animation)
        {
            ...
            Debug.Log("PreviewAnimComAnimation");

            Vector3 moveFrom = UIAnimator.GetAnimationMoveFrom(view.RectTransform, animation, view.StartPosition);
            Vector3 moveTo = UIAnimator.GetAnimationMoveTo(view.RectTransform, animation, view.StartPosition);
            if (!animation.Move.Enabled) view.ResetPosition();
            else PreviewMove(view.RectTransform, moveFrom, moveTo, animation, view.StartPosition);
        ...
        public static void PreviewPopupAnimation(UIPopup popup, UIAnimation animation)
        {
            ...
            if (popup.Container != null) StopAllAnimations(popup.Container.RectTransform);
            if (popup.Overlay != null) StopAllAnimations(popup.RectTransform);
            ...
            if (animation.Enabled && popup.Overlay != null && popup.Overlay.CanvasGroup != null && popup.Overlay.Enabled)
            {
        ...
        public static void StopPreview(UIBaseComponent view)
        {
        ...
        public static void StopPopupPreview(UIPopup popup)
        {
            ...
            if (popup.Overlay != null) popup.Overlay.ResetToStartValues();
            s_previewIsPlaying = false;
        }
