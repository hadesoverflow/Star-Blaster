...
namespace Imba.Editor.UI
{
    ...
    public class UIViewControllerEditor : UIBaseEditor
    {
        private UIViewController m_target;

        private UIViewController Target
        {
            get
            {
                if (m_target != null) return m_target;
                m_target = (UIViewController) target;
                return m_target;
            }
        }
        ...
        protected override void LoadSerializedProperty()
        {
            ...
            m_viewName = serializedObject.FindProperty("ViewName");
        ...
        public override void OnInspectorGUI()
        {
            ...
            //Target.HideByBackButton = EditorGUILayout.Toggle(new GUIContent("Hide By Back Button","Determine if this view can hide when click Back Button"), Target.HideByBackButton);
            Target.CanGoBack = EditorGUILayout.Toggle(new GUIContent("Can Go Backs","Determine if this view can go back from next view or not"), Target.CanGoBack);
        ...
        private void DrawPreviewAnimationButtons(SerializedObject serializedObject, UIView view, UIViewBehavior viewBehavior)
        {
        ...
        private void DrawBehaviorAnimation(UIViewBehavior behavior, SerializedProperty animationProperty, SerializedProperty instantAnimationProperty)
        {
            ...
            if (!instantAnimationProperty.boolValue)
            {
                ...
                if (behavior.Animation.Enabled)
                    DrawPreviewAnimationButtons(serializedObject, Target.View, behavior);
        ...
        private void PreviewAnim(UIAnimation anim, UIView view)
        {
        ...
        private void StopPreviewAnim(UIView view)
        {
